...
* `CTB-44` for determinism, replay-safe processing, and correctness-focused testing expectations in `docs/architecture/ctb-simulator-determinism-replay-and-correctness-policy.md`
