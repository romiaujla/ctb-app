...
* `CTB-43` simulator accounting, portfolio snapshot, and event-history model work in `docs/architecture/ctb-simulator-accounting-and-event-history-model.md`
* `CTB-44` deterministic and replay-safe simulator-core policy and correctness-focused test direction in `docs/architecture/ctb-simulator-determinism-replay-and-correctness-policy.md`
...
* `CTB-36` monorepo structure baseline
